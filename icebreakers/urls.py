...
urlpatterns = [
    ...
    path("<str:code>/dash/<int:dashboard_id>/preview/", dashboard_views.dashboard_preview, name="dashboard_preview"),
    ...
    path("<str:code>/dash/<int:dashboard_id>/publish/", dashboard_views.dashboard_publish, name="dashboard_publish"),
    path("<str:code>/dash/<int:dashboard_id>/unpublish/", dashboard_views.dashboard_unpublish, name="dashboard_unpublish"),
    path("<str:code>/dash/<int:dashboard_id>/qr.svg", dashboard_views.dashboard_qr, name="dashboard_qr"),
